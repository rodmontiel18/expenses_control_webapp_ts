...
const NewUserForm = () => {
  ...
  const stateSetters: Map<
    string,
    React.Dispatch<SetStateAction<any>>
  > = new Map<string, React.Dispatch<SetStateAction<any>>>([
  ...
  const createUser = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    let lBirthdayError: boolean = false,
      lCPwdError: boolean = false,
      lEmailError: boolean = false,
      lNameError: boolean = false,
      lLastnameError: boolean = false,
      lPwdError: boolean = false;
  ...
  const handleChangeInput = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const errorSetter: React.Dispatch<any> | undefined = stateSetters.get(
      name + "Error"
    );
    ...
    <div className="col m-4">
      ...
      >
        ...
        <div className="form-group input-group">
          ...
          <div className="input-group" style={{ margin: "5px 0 0 45px" }}>
            <p
              className={showCPwdError ? "" : "hidden"}
              style={{ color: "red" }}
            >
